...
function bones_scripts_and_styles() {
	...
	if (!is_admin()) {
		...
		// Why
		wp_register_script('why', get_stylesheet_directory_uri() . '/library/js/why.js', array('jquery'), '', true);
		
		// Join
		wp_register_script('join', get_stylesheet_directory_uri() . '/library/js/join.js', array('jquery'), '', true);
		
		// Create Race
		wp_register_script('create-race', get_stylesheet_directory_uri() . '/library/js/create-race.js', array('jquery'), '', true);
		...
		//Race Options Slides CSS
		wp_register_style('options-css', get_stylesheet_directory_uri() . '/library/css/simple-slider.css', array(), '' );
		...
		if (is_page_template("pagetemplate-createofflinegamefour.php") || is_page_template("pagetemplate-creategamefour.php") || is_page("join") || is_page("races") || is_page_template('pagetemplate-help.php') || is_page_template("pagetemplate-tokenjoin.php")) {
...
function bones_excerpt_more($more) {
	...
	return '.';
//<a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'bonestheme' ) . get_the_title($post->ID).'">'. __( 'Read more &raquo;', 'bonestheme' ) .'</a>
}
