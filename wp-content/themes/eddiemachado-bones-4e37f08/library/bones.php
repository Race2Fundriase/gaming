...
function bones_scripts_and_styles() {
	...
	if (!is_admin()) {
		...
		if (is_page_template("pagetemplate-creategamefour.php") || is_page("join") || is_page("races") || is_page_template('pagetemplate-help.php') || is_page_template("pagetemplate-tokenjoin.php")) {
