<?php
/*
Template Name: Token Category Admin
*/
...
<div id="content">
	...
	<div id="tokenOptions" class="boxShadow">
		...
		<div><label for="categoryName" id="categoryNameLabel"><span>Category Name:</span></label><input type="text" id="categoryName" value="" required /></div>
		<input type="button" value="Apply" id="upsertTokenCategory"/>
		</div>
		</form>
	</div>
